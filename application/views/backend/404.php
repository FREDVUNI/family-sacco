				...
				<div class="container d-lg-flex align-items-lg-center min-vh-lg-100">
					<div class="w-lg-60 w-xl-50">
						<div class="mb-4">
							...
							<p class="h4">Oops! Looks like you followed a bad link <a class="font-primary"
									href="<?php echo base_url("dashboard");?>"><br/> return to dashboard</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<footer class="position-absolute right-0 bottom-0 left-0">
			<div class="container">
				<div class="d-flex justify-content-between align-items-center space-1">
					<p class="text-muted mb-0">© Family Savings Dashboard <?php echo date('Y');?>.</p>
